...
namespace MedicineShopApplication.BLL.Services
{
    public interface IUserService
    {
        ...
        Task<UserDto> AddUser(CreateUserRequestDto userInsertDto);
        Task UpdateUser(UpdateUserRequestDto userUpdateDto);
    ...
    public class UserService : IUserService
    {
        ...
        public async Task<UserDto> AddUser(CreateUserRequestDto userInsertDto)
        {
        ...
        public async Task UpdateUser(UpdateUserRequestDto userUpdateDto)
        {
